                ...
                <div class="modal_block" role="document">
                  <form role="form" method="POST" action="{{ url('/password/reset') }}">
                        ...
                        <div class="form-group title_block">
                         ...
                         <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }} first_block">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }} confirm_block">
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }} confirm_block">
                        ...
                        <div class="form-group save_block">
                            <button type="submit" class="btn_login">Save and continue</button>
                        </div>
                        <div class="form-group terms_block">
                            <p>
                                By clicking “Save and Continue,” you confirm that you
