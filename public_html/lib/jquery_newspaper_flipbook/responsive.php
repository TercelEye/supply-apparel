<html>
  <head>
    ...
    <!-- title -->
    <!-- <title>responsive Newspaper FlipBook -jQuery</title>         -->
    ...
    <div class="fb5" id="fb5">      
        ...
        <section id="config">
         <ul>
            ...
            <li key="pdf_url"><?=$_GET['pdf']?></li>		                <!-- pathway to a pdf file ( the file will be read live ) -->
